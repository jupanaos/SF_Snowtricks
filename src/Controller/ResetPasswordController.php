...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator, UrlGeneratorInterface $urlGenerator): Response
    {
        ...
        return $this->render('app/pages/security/reset_password/request.html.twig', [
    ...
    public function checkEmail(): Response
    {
        ...
        return $this->render('app/pages/security/reset_password/check_email.html.twig', [
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        ...
        return $this->render('app/pages/security/reset_password/reset.html.twig', [
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator, UrlGeneratorInterface $urlGenerator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('no-reply@snowtricks.com', 'Securite'))
            ->to($user->getEmail())
            ->subject('Snowtricks - Votre demande de réinitialisation de mot de passe')
